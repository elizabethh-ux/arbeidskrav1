...
print(trafikkavgift)
bom_el = km * 0.10  # bomavgiften for antall km elbil, ganger km med 0.1 for å finne total bomacgift på 10000km 
print(bom_el)
total_el = strompris + forsikring_el + trafikkavgift + bom_el  # plusser sammen alle kostbader for totalkostnader elbil 
